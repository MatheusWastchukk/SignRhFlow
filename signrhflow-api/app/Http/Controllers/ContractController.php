...
class ContractController extends Controller
{
    #[OA\Get(
        ...
        responses: [
            new OA\Response(response: 200, description: 'Lista paginada de contratos'),
        ]
    )]
    ...
    #[OA\Post(
        ...
        responses: [
            new OA\Response(response: 201, description: 'Contrato criado'),
    ...
    public function store(StoreContractRequest $request): JsonResponse
    {
        ...
        $data['file_path'] = $data['file_path'] ?? 'storage/app/contracts/pending.pdf';

        $contract = Contract::query()->create($data)->load('employee');
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(response: 200, description: 'Contrato encontrado'),
